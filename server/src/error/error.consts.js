const errorMessages = {
  ...
  PASSWORD_EMPTY: "Password cannot be an empty field. 😊",
  INTERNAL_SERVER_ERROR: "Oops, we are sorry but there is a problem with our servers. 😱",
  BAD_REQUEST: "Ooops, you have sent a bad request. 😯",
};
